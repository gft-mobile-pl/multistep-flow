...
import com.gft.multistepflow.example.domain.wildcard.actions.AcceptUsernameAction
...
val wildcardLoginFlowDomainModule = module {
    ...
    factory(WildcardLoginFlowQualifier) { StartMultiStepFlowUseCase<StepType<*, *, *, *>>(get(WildcardLoginFlowQualifier)) }
    factory(WildcardLoginFlowQualifier) { EndMultiStepFlowUseCase(get(WildcardLoginFlowQualifier)) }
    ...
    factory { AcceptUsernameAction(get(WildcardLoginFlowQualifier), get(WildcardLoginFlowQualifier)) }
}
